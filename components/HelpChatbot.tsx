  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-20 lg:bottom-6 right-4 lg:right-6 z-50 w-12 h-12 lg:w-14 lg:h-14 rounded-2xl shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-105 ${
      ...
      {/* Chat panel */}
      {open && (
        <div className="fixed bottom-[5.5rem] lg:bottom-24 right-2 lg:right-6 z-50 w-[calc(100vw-1rem)] sm:w-[400px] max-h-[70vh] lg:max-h-[560px] bg-white rounded-2xl shadow-2xl border border-slate-200 flex flex-col overflow-hidden">
          {/* Header */}
