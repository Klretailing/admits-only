      ...
      <aside className="hidden lg:flex flex-col w-64 bg-white border-r border-slate-100">
        <div className="p-5 border-b border-slate-100">
          <Link href="/" className="flex items-center gap-2.5 group">
            <div className="w-9 h-9 rounded-xl bg-accent flex items-center justify-center shadow-sm transition-shadow">
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${
                      active ? 'bg-accent/8 text-accent' : 'text-slate-500 hover:text-primary hover:bg-slate-50'
                    }`}
                  >
                    {link.icon}
                    {link.label}
            ...
            <div className="p-4 border-t border-slate-100">
              {isAdmin && (
                <Link
                  ...
                  className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-amber-700 bg-amber-50 hover:bg-amber-100 transition-all mb-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
